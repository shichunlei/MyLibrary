package chingtech.library.decoration;
...
public abstract class NormalDecoration extends RecyclerView.ItemDecoration {
    ...
    protected String TAG = "NormalDecoration";
     ...
     */
    @Override
    public void getItemOffsets(Rect outRect, View itemView, RecyclerView parent,
        ...
        if (pos == 0 || !curHeaderName.equals(
                getHeaderName(pos - 1))) {//如果当前位置为0，或者与上一个item头部名不同的，都腾出头部空间
    ...
    public void onDrawOver(Canvas canvas, RecyclerView recyclerView, RecyclerView.State state) {
            ...
            if (pos == 0 || !curHeaderName.equals(
                ...
                if (headerDrawEvent != null) {
                    ...
                    if (headViewMap.get(pos) == null) {
                        ...
                        canvas.drawBitmap(headerView.getDrawingCache(), left,
                                          viewTop - headerHeight, null);
                    ...
                    canvas.drawRect(left, viewTop - headerHeight, right, viewTop,
                                    mHeaderContentPaint);
                    canvas.drawText(curHeaderName, left + textPaddingLeft,
                                    viewTop - headerHeight / 2 + txtYAxis, mHeaderTxtPaint);
                }
        ...
        if (headerDrawEvent != null) {//inflater
            ...
            canvas.drawText(firstHeaderName, left + textPaddingLeft, headerHeight / 2 + txtYAxis,
                            mHeaderTxtPaint);
        }
        canvas.restore();
        Log.i(TAG, "绘制悬浮头部");
