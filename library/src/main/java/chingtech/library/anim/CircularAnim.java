...
public class CircularAnim {
    ...
    public static class VisibleBuilder {
        ...
        public VisibleBuilder onAnimationEndListener(
        ...
        public void go(OnAnimationEndListener onAnimationEndListener) {
            ...
            try {
                Animator anim = ViewAnimationUtils.createCircularReveal(mAnimView, rippleCX,
                                                                        rippleCY, mStartRadius,
                                                                        mEndRadius);
    ...
    public static class FullActivityBuilder {
        ...
        public void go(OnAnimationEndListener onAnimationEndListener) {
            ...
            try {
                Animator anim = ViewAnimationUtils.createCircularReveal(view, cx, cy, mStartRadius,
                                                                        finalRadius);
