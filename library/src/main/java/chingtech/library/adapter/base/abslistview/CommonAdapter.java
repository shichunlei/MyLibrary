...
public abstract class CommonAdapter<T> extends BaseAdapter implements DataHelper<T> {
    ...
    public CommonAdapter(Context context, List<T> list, int... layoutIds) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        onUpdate(holder, mList.get(position), position);
    ...
    public abstract void onUpdate(BaseAbsListHolder holder, T item, int position);
