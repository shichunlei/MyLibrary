...
public class BaseAbsListHolder implements ViewHelper.AbsListView<BaseAbsListHolder> {
     ...
     */
    @Override
    public BaseAbsListHolder setViewHeight(int viewId, ViewUtils.Proportion type) {
        View view = getView(viewId);
     ...
     */
    @Override
    public BaseAbsListHolder setViewHeight(int viewId, ViewUtils.Proportion type, float screen) {
        View view = getView(viewId);
