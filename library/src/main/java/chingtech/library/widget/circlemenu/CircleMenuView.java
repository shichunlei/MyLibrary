package chingtech.library.widget.circlemenu;
...
public class CircleMenuView extends FrameLayout implements View.OnClickListener {
    ...
    public CircleMenuView(@NonNull Context context, @Nullable AttributeSet attrs,
        ...
        final TypedArray a = context.getTheme()
                                    .obtainStyledAttributes(attrs, R.styleable.CircleMenuView, 0,
                                                            0);
        try {
            ...
            mIconMenu = a.getResourceId(R.styleable.CircleMenuView_icon_menu,
                                        R.drawable.ic_menu_black_24dp);
            mIconClose = a.getResourceId(R.styleable.CircleMenuView_icon_close,
                                         R.drawable.ic_close_black_24dp);

            mDurationRing = a.getInteger(R.styleable.CircleMenuView_duration_ring,
                                         getResources().getInteger(
                                                 android.R.integer.config_mediumAnimTime));
            mDurationOpen = a.getInteger(R.styleable.CircleMenuView_duration_open,
                                         getResources().getInteger(
                                                 android.R.integer.config_mediumAnimTime));
            mDurationClose = a.getInteger(R.styleable.CircleMenuView_duration_close,
                                          getResources().getInteger(
                                                  android.R.integer.config_mediumAnimTime));
     ...
     */
    public CircleMenuView(@NonNull Context context, @NonNull List<Integer> icons,
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        final LayoutParams lp
                = (LayoutParams) mRingView.getLayoutParams();//new LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.MATCH_PARENT);
        lp.width = right - left;
    ...
    public void onClick(final View view) {
        ...
        click.addListener(new AnimatorListenerAdapter() {
            ...
            public void onAnimationStart(Animator animation) {
                if (mListener != null) {
                    mListener.onButtonClickAnimationStart(CircleMenuView.this,
                                                          mButtons.indexOf(view));
                }
            }
            ...
            public void onAnimationEnd(Animator animation) {
                if (mListener != null) {
                    mListener.onButtonClickAnimationEnd(CircleMenuView.this,
                                                        mButtons.indexOf(view));
                }
            }
        });
    ...
    private void initMenu(int menuButtonColor) {
        ...
        mMenuButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                final Animator animation = mClosedState ? getOpenMenuAnimation() :
    ...
    private Animator getButtonClickAnimation(final @NonNull FloatingActionButton button) {
        ...
        final ObjectAnimator scaleX  = ObjectAnimator.ofFloat(mRingView, "scaleX", 1f,
                                                              DEFAULT_RING_SCALE_RATIO);
        final ObjectAnimator scaleY  = ObjectAnimator.ofFloat(mRingView, "scaleY", 1f,
                                                              DEFAULT_RING_SCALE_RATIO);
    ...
    private Animator getOpenMenuAnimation() {
        ...
        final PropertyValuesHolder pvhRotation     = PropertyValuesHolder.ofKeyframe("rotation",
                                                                                     kf0, kf1, kf2);
        final ObjectAnimator       rotateAnimation = ObjectAnimator.ofPropertyValuesHolder(
                mMenuButton, pvhRotation);
