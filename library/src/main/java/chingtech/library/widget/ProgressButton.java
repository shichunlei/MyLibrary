...
public class ProgressButton extends View {
    ...
    private void initPaint() {
        mStrokeWidth = (int) dp2px(2);
        mPadding = (int) dp2px(2);
        mProRadius = getMeasuredHeight() / 5;

        mProgerssButtonAnim = new ProgerssButtonAnim();
        mProgerssRotateAnim = new RotateAnimation(0f, 360f, Animation.RELATIVE_TO_SELF, 0.5f,
        ...
        paintText.setTextSize(dp2px(15));
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mSpac < (getMeasuredWidth() - getMeasuredHeight()) / 2.0f) {
            ...
            canvas.drawText(text, getMeasuredWidth() / 2.0f - getFontlength(paintText, text) / 2.0f,
    ...
    public void stopAnim(final OnStopAnim mOnStopAnim) {
        ...
        if (mProgerssScaleAnim != null) {
            ...
            mProgerssScaleAnim = new ScaleAnimation(1.0f, width / getMeasuredHeight() * 3.5f, 1.0f,
                                                    width / getMeasuredHeight() * 3.5f,
                                                    Animation.RELATIVE_TO_SELF, 0.5f,
                                                    Animation.RELATIVE_TO_SELF, 0.5f);
        }
