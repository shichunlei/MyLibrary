...
public class RecyclerViewBanner extends FrameLayout {
    ...
    public RecyclerViewBanner(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mInterval = a.getInt(R.styleable.RecyclerViewBanner_rvb_interval, MILLI_SECOND);
        ...
        mSpace = a.getDimensionPixelSize(R.styleable.RecyclerViewBanner_rvb_indicatorSpace,
                ScreenUtils.dip2px(context, 4));
        int margin = a.getDimensionPixelSize(R.styleable.RecyclerViewBanner_rvb_indicatorMargin,
                ScreenUtils.dip2px(context, 8));
    ...
    private GradientDrawable generateDefaultDrawable(int color) {
        ...
        gradientDrawable.setSize(ScreenUtils.dip2px(context, 6), ScreenUtils.dip2px(context, 6));
        gradientDrawable.setCornerRadius(ScreenUtils.dip2px(context, 6));
    ...
    private void createIndicators() {
        ...
        for (int i = 0; i < mData.size(); i++) {
            ...
            if (mSize >= ScreenUtils.dip2px(context, 4)) { // 设置了indicatorSize属性
                lp.width = lp.height = mSize;
            } else {
                // 如果设置的resource.xml没有明确的宽高，默认最小2dp，否则太小看不清
                img.setMinimumWidth(ScreenUtils.dip2px(context, 2));
                img.setMinimumHeight(ScreenUtils.dip2px(context, 2));
            }
    ...
    private class RecyclerAdapter extends RecyclerView.Adapter {
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
            AppCompatImageView img = (AppCompatImageView) holder.itemView.findViewById(
                    R.id.rvb_banner_image_view_id);
    ...
    private class PagerSnapHelper extends LinearSnapHelper {
        ...
        public int findTargetSnapPosition(RecyclerView.LayoutManager layoutManager, int velocityX,
            ...
            if (targetPos != RecyclerView.NO_POSITION && currentView != null) {
                ...
                currentPos = targetPos < currentPos ? last
                        : (targetPos > currentPos ? first : currentPos);
