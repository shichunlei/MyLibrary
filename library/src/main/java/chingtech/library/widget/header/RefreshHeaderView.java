package chingtech.library.widget.header;
...
import chingtech.library.widget.GoogleCircleProgressView;

/**
 * Created by leo on 2017/1/10.
 */
public class RefreshHeaderView extends FrameLayout implements SwipeTrigger,
        SwipeRefreshTrigger {
    ...
    protected void onFinishInflate() {
        ...
        progressView.setColorSchemeResources(R.color.google_blue, R.color.google_red, R.color.google_yellow,
