...
public class PeriscopeLayout extends RelativeLayout {
     ...
     * 桃心
     */
    private int[] heartRes = new int[] {R.drawable.pl_blue, R.drawable.pl_red,
            R.drawable.pl_yellow};

    /**
     * 插补器
     */
    private Interpolator[] interpolators = new Interpolator[] {new LinearInterpolator(),
            new AccelerateInterpolator(), new DecelerateInterpolator(),
            new AccelerateDecelerateInterpolator(), new BounceInterpolator(),
    ...
    public PeriscopeLayout(@NonNull Context context) {
        this(context, null);
    }

    public PeriscopeLayout(@NonNull Context context, @Nullable AttributeSet attrs) {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.PeriscopeLayout);
        mEnterDuration = a.getInt(R.styleable.PeriscopeLayout_pl_enter_duration, mEnterDuration);
        mDuration = a.getInt(R.styleable.PeriscopeLayout_pl_duration, mDuration);
        mScale = a.getFloat(R.styleable.PeriscopeLayout_pl_scale, mScale);
        mIsSameSize = a.getBoolean(R.styleable.PeriscopeLayout_pl_same_size, mIsSameSize);
    ...
    private ValueAnimator getBezierCurveAnimator(final View target) {
        ...
        valueAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                ...
                //透明度 从不透明到完全透明
                target.setAlpha(
                        1.0f - animation.getAnimatedFraction() * animation.getAnimatedFraction());
            }
        });
