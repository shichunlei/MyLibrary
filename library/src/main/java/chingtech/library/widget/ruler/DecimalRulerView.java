...
public class DecimalRulerView extends View {
    ...
    protected void init(Context context) {
        ...
        mItemSpacing = ScreenUtils.dip2px(getContext(), 14);
        mLineWidth = ScreenUtils.dip2px(getContext(), 1);
        mMaxLineHeight = ScreenUtils.dip2px(getContext(), 42);
        mMiddleLineHeight = ScreenUtils.dip2px(getContext(), 31);
        mMinLineHeight = ScreenUtils.dip2px(getContext(), 17);
        mTextMarginTop = ScreenUtils.dip2px(getContext(), 11);

        mTextPaint = new Paint(Paint.ANTI_ALIAS_FLAG);
        mTextPaint.setTextSize(ScreenUtils.sp2px(getContext(), 16));
    ...
    public void setParam(int itemSpacing, int maxLineHeight, int middleLineHeight,
            int minLineHeight, int textMarginTop, int textSize) {
        ...
        for (int i = 0; i < mTotalLine; i++) {
            ...
            if (i % 10 == 0) { // 大指标,要标注文字
                ...
                canvas.drawText(value, left - mTextPaint.measureText(value) / 2,
                                height + mTextMarginTop + mTextHeight - ScreenUtils.dip2px(
                                        getContext(), 3), mTextPaint);
            }
