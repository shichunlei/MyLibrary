 ...
 * Description:
 * Created by 师春雷
 * Created at 17/10/28 上午9:49
 */
public class IntegerRulerView extends View {
    ...
    public IntegerRulerView(Context context) {
        this(context, null);
    }

    public IntegerRulerView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);

    }

    public IntegerRulerView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        for (int i = 0; drawCount <= 4 * width; i++) {
            ...
            if (xPosition + getPaddingRight() < mWidth && (mValue + i) <= mMaxValue) {
                if ((mValue + i) % mModType == 0) {
                    canvas.drawLine(xPosition, getHeight(), xPosition,
                                    getHeight() - mDensity * ITEM_MAX_HEIGHT, mLinePaint);
                    ...
                    canvas.drawLine(xPosition, getHeight(), xPosition,
                                    getHeight() - mDensity * ITEM_MIN_HEIGHT, mLinePaint);
                }
            }
