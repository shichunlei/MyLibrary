...
public class RoundTextView extends AppCompatTextView {
    ...
    private void setAttributeSet(Context context, AttributeSet attrs) {
        ...
        //int solid = a.getColor(R.styleable.RoundTextView_textSolidColor, Color.TRANSPARENT);
        int strokeColor = a.getColor(R.styleable.RoundTextView_textStrokeColor, Color.TRANSPARENT);
        radius = a.getDimensionPixelSize(R.styleable.RoundTextView_textRadius, 0);
        int leftTopRadius = a.getDimensionPixelSize(R.styleable.RoundTextView_textLeftTopRadius, 0);
        int leftBottomRadius = a.getDimensionPixelSize(
                R.styleable.RoundTextView_textLeftBottomRadius, 0);
        int rightTopRadius = a.getDimensionPixelSize(R.styleable.RoundTextView_textRightTopRadius,
                                                     0);
        int rightBottomRadius = a.getDimensionPixelSize(
                R.styleable.RoundTextView_textRightBottomRadius, 0);
        strokeWidth = a.getDimensionPixelSize(R.styleable.RoundTextView_textStrokeWidth, 0);
        int normalTextColor = a.getColor(R.styleable.RoundTextView_textNormalTextColor,
                                         Color.TRANSPARENT);
        int selectedTextColor = a.getColor(R.styleable.RoundTextView_textSelectedTextColor,
                                           Color.TRANSPARENT);
        int normalSolidColor = a.getColor(R.styleable.RoundTextView_textNormalSolidColor,
                                          Color.TRANSPARENT);
        int pressedSolidColor = a.getColor(R.styleable.RoundTextView_textPressedSolidColor,
                                           Color.TRANSPARENT);
        boolean  isSelected     = a.getBoolean(R.styleable.RoundTextView_textIsSelected, false);
        boolean  noLeftStroke   = a.getBoolean(R.styleable.RoundTextView_textNoLeftStroke, false);
        boolean  noRightStroke  = a.getBoolean(R.styleable.RoundTextView_textNoRightStroke, false);
        boolean  noTopStroke    = a.getBoolean(R.styleable.RoundTextView_textNoTopStroke, false);
        boolean  noBottomStroke = a.getBoolean(R.styleable.RoundTextView_textNoBottomStroke, false);
        Drawable textDrawable   = a.getDrawable(R.styleable.RoundTextView_textDrawable);
        ...
        setPressedState(leftTopRadius, leftBottomRadius, rightBottomRadius, rightTopRadius,
                        strokeColor, pressedSolidColor, noLeftStroke, noRightStroke, noTopStroke,
                        noBottomStroke, isSelected);

        //set normal state
        setNormalState(leftTopRadius, leftBottomRadius, rightBottomRadius, rightTopRadius,
                       strokeColor, normalSolidColor, noLeftStroke, noRightStroke, noTopStroke,
                       noBottomStroke);
        ...
        if (normalTextColor != 0 && selectedTextColor != 0) {
            ...
            if (isSelected) { //是否可以选中
                ...
                states[1] = new int[] {};
                textColorSelect = new ColorStateList(states, new int[] {selectedTextColor,
                        normalTextColor});
            } else {
     ...
     */
    private void setNormalState(int leftTopRadius, int leftBottomRadius, int rightBottomRadius,
            int rightTopRadius, int strokeColor, int normalSolid, boolean noLeftStroke,
        ...
        //设置正常状态下描边边距
        setStrokeMargin(normalLayerDrawable, 0, noLeftStroke, noRightStroke, noTopStroke,
                        noBottomStroke);
        //设置正常状态下的drawable
     ...
     */
    private void setPressedState(int leftTopRadius, int leftBottomRadius, int rightBottomRadius,
            int rightTopRadius, int strokeColor, int pressedSolid, boolean noLeftStroke,
            boolean noRightStroke, boolean noTopStroke, boolean noBottomStroke,
            boolean isSelected) {
        ...
        if (pressedSolid != Color.TRANSPARENT) {
            ...
            //设置圆角
            setRadius(pressedGD, leftTopRadius, leftBottomRadius, rightBottomRadius,
                      rightTopRadius);

            LayerDrawable pressedLayerDrawable = new LayerDrawable(new Drawable[] {pressedGD});
            setStrokeMargin(pressedLayerDrawable, 0, noLeftStroke, noRightStroke, noTopStroke,
                            noBottomStroke);
            //设置按下状态
            if (isSelected) {
     ...
     * @param bottom        下边距
     */
    private void setStrokeMargin(LayerDrawable layerDrawable, int index, boolean left,
            boolean right, boolean top, boolean bottom) {
    ...
    public void setTextDrawable(int drawableId) {
        if (drawableId != 0) {
            Drawable       textdrwable = ContextCompat.getDrawable(context, drawableId);
     ...
     */
    public void setRadius(int leftTopRadius, int leftBottomRadius, int rightTopRadius,
            int rightBottomRadius) {
        normalGD.setCornerRadii(
                new float[] {leftTopRadius, leftTopRadius, rightTopRadius, rightTopRadius,
    ...
    public void setStrokeColorAndWidth(int strokeWidth, int colorId) {
        normalGD.setStroke(strokeWidth, ContextCompat.getColor(context, colorId));
    }
    ...
    public void setSelectedTextColor(int normalTextColor, int selectedTextColor) {
        ...
        normalTextColor = ContextCompat.getColor(context, normalTextColor);
        selectedTextColor = ContextCompat.getColor(context, selectedTextColor);
