...
public class MaskTransformation implements Transformation<Bitmap> {
    ...
    /**
     * @param maskId If you change the mask file, please also rename the mask file, or Glide will
     *               get
     *               the cache with the old mask. Because getId() return the same values if using
     *               the
