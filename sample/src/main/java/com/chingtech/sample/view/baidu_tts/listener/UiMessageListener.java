package com.chingtech.sample.view.baidu_tts.listener;
...
public class UiMessageListener extends MessageListener {
    ...
    public void onSynthesizeDataArrived(String utteranceId, byte[] data, int progress) {
        ...
        mainHandler.sendMessage(
                mainHandler.obtainMessage(UI_CHANGE_SYNTHES_TEXT_SELECTION, progress, 0));
    }
    ...
    public void onSpeechProgressChanged(String utteranceId, int progress) {
        ...
        mainHandler.sendMessage(
                mainHandler.obtainMessage(UI_CHANGE_INPUT_TEXT_SELECTION, progress, 0));
    }
